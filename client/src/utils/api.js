...
export const api = axios.create({
  baseURL: "https://real-estate-server-red.vercel.app/api",
});
...
export const createResidency = async (data, email) => {
  ...
  if(!data["userEmail"]) {
    ...
    {
      toast.error("Something went wrong while create a residency");
      throw error
    }
  }
